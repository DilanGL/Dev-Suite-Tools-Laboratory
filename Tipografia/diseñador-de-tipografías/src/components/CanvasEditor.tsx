...
export default function CanvasEditor({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 max-w-xs bg-[#1a1a1a]/95 backdrop-blur p-3 rounded border border-[#333] text-[11px] text-gray-400">
        <h4 className="font-bold text-white uppercase tracking-wide mb-1 flex items-center gap-1">
