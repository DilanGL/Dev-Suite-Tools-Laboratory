...
export default function Sidebar({
  ...
  const handleLoadPreset = (id: string, name: string) => {
    const confirmPreset = window.confirm(`¿Seguro que deseas cargar la plantilla "${name}"? Esto reemplazará tu tipografía actual.`);
    if (confirmPreset) {
      const presetProj = createPremadeProject(id);
      onChangeProject(presetProj);
      showStatus('success', `¡Plantilla "${name}" cargada correctamente!`);
    }
  };
